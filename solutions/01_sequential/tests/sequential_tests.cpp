...
void test_sequential_normalizes_and_classifies()
{
    ...
    const auto output = financial::seq::process_records(input, reference);
...
int main()
{
    try {
        ...
        test_sequential_normalizes_and_classifies();

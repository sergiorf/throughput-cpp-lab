...
financial::optimized::AllocationMode allocation_mode(std::string_view value)
{
    if (value == "heap") {
        return financial::optimized::AllocationMode::ordinary;
    }
    return financial::optimized::AllocationMode::batch_arena;
}

const char* allocation_mode_name(financial::optimized::AllocationMode mode)
{
    return mode == financial::optimized::AllocationMode::ordinary ? "heap" : "arena";
}
...
int main(int argc, char** argv)
{
    ...
    const auto mode = argc > 5 ? allocation_mode(argv[5]) : financial::optimized::AllocationMode::batch_arena;
